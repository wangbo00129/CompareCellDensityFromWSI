...
df_density_per_tissue_all_samples_pivot_table_append_tissue_percentage_append_ihc = pd.read_csv('df_density_per_tissue_all_samples_pivot_table_append_tissue_percentage_append_ihc.csv', index_col=0)
all_possible_labels = joblib.load('all_possible_labels.pkl')
all_possible_input_features = joblib.load('all_possible_input_features.pkl')
...
joblib.dump(prediction_results, 'prediction_results.pkl')